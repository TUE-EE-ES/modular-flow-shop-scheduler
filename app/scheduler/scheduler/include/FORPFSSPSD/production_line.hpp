#ifndef FORPFSSPSD_PRODUCTION_LINE
#define FORPFSSPSD_PRODUCTION_LINE
...
struct TransferPoint {
     ...
     */
    FMS::DefaultMap<JobId, delay> setupTime;
...
using ModulesTransferConstraints = FMS::TwoKeyMap<ModuleId, TransferPoint>;
...
public:
    ...
    [[nodiscard]] inline size_t numberOfModules() const { return m_modules.size(); }
    ...
    [[nodiscard]] inline FORPFSSPSD::ModuleId getFirstModuleId() const {
        return m_moduleIds.front();
    }
...
#endif // FORPFSSPSD_PRODUCTION_LINE
