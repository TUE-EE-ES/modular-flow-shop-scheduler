...
void writeProcessingTime(xml_document<char>& doc,xml_node<> *pTimes, const char * jobCount, delay pVal){
...
void addAttribute(xml_document<char>& doc, xml_node<> *node, const char* attr_name, const char* attr_value ){
